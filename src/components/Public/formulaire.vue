<template>
  ...
  <div>
    ...
    <div class="stepper">
      ...
      <div class="stepper-item" :class="{ current: currentStep == item, success: currentStep > item }" v-for="item in 3"
        :key="item">
    ...
    <form class="form">
        ...
        <div class="form-container">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner la région" v-model="step1.region" color="secondary"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner la préfecture" v-model="step1.prefecture" color="secondary"
                    :options="prefectureOptions1" v-slot="{ option }" search :disabled="isPrefectureDisabled">
                    <div class="flex items-center" style="
                          padding-top: 0.5rem;
                          padding-bottom: 0.5rem;
                          width: 100%;
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner la commune" v-model="step1.commune" color="secondary"
                    :options="sous_prefectureOptions" @click="handleChange"
                    :class="{ 'error-border': resultError['Commune'] }" @input="resultError['Commune'] = false"
                    v-slot="{ option }" search :disabled="isCommuneDisabled">
                    <div class="flex items-center" style="
                          padding-top: 0.5rem;
                          padding-bottom: 0.5rem;
                          width: 100%;
          ...
          <div class="content">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  <label for="SigleMpme">Sigle Mpme </label>
                  <input type="text" name="SigleMpme" id="SigleMpme" placeholder="DNPMECL" v-model="step1.sigle_mpme"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="nom" id="nom" placeholder="DNPMECL" v-model="step1.nom"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner le quartier" v-model="step1.quartier" color="secondary"
                    :options="QuartierOptions" :class="{ 'error-border': resultError['Quartier'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="email" name="email" id="AdresseEmail" placeholder="dnpmecl@gmail.com" v-model="step1.email"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="url" name="url" id="SiteWeb" placeholder="https://exemple.com" v-model="step1.url"
          ...
          <div class="content">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner une année" v-model="step1.an_creation" color="secondary"
                    :options="yearOptions" :class="{ 'error-border': resultError['AnneeCreation'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="AnneeEntreeActivite">Année d'Entrée en Activité <span class="text-danger">*</span></label>
                  <MazSelect v-model="step1.an_entre_acti" label="Sélectionner une année" color="secondary"
                    :options="yearOptions" :class="{ 'error-border': resultError['AnneeEntreeActivite'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect v-model="step1.code_st_juriq" label="Sélectionner votre statut juridique" color="secondary"
                    :options="StatutJuridiqueOptions" :class="{ 'error-border': resultError['CodeStatutJuridique'] }"
                    @input="resultError['CodeStatutJuridique'] = false" :disabled="step1.code_st_juriq "
                    search />
                </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre statut juridique" v-model="step1.autr_st_juriq" color="secondary"
                    :options="StatutJuridiqueOptions" :class="{ 'error-border': resultError['AutreStatutJuridique'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre secteur activité" v-model="step1.prin_sect_acti" color="secondary"
                    :options="SecteurActiviteOptions" :class="{ 'error-border': resultError['PrincipalSecteurActivite'] }"
                    @input="resultError['PrincipalSecteurActivite'] = false"
                    :disabled="step1.prin_sect_acti" search />
                </div>
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="ListeSousSecteurActivite">Liste Sous Secteur Activite <span
                      class="text-danger">*</span></label>
                  <v-select v-model="step1.selectedSousSecteurs" :items="SousSecteurActiviteOptions" multiple
                    persistent-hint item-title="state" item-value="abbr"
                    :class="{ 'error-border': resultError['ListeSousSecteurActivite'] }"
                    @input="resultError['ListeSousSecteurActivite'] = false"></v-select>
                </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre pays" v-model="step1.PaysSiegeSocial"
                    :options="sortedCountryOptions" v-slot="{ option }" search color="secondary"
                    :class="{ 'error-border': resultError['PaysSiegeSocial'] }"
                    @input="resultError['PaysSiegeSocial'] = false" option-value-key="value" option-label-key="label"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="PersonnelPermanentFemme" id="PersonnelPermanentFemme" placeholder="21"
                    v-model="step1.pers_per_femm" :class="{ 'error-border': resultError['PersonnelPermanentFemme'] }"
                    @input="resultError['PersonnelPermanentFemme'] = false" option-value-key="value"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="PersonnelPermanentHomme" id="PersonnelPermanentHomme" placeholder="11"
                    v-model="step1.pers_per_homm" :class="{ 'error-border': resultError['PersonnelPermanentHomme'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="PersonnelTemporaireFemme" id="PersonnelTemporaireFemme" placeholder="33"
                    v-model="step1.pers_temp_femm" :class="{ 'error-border': resultError['PersonnelTemporaireFemme'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="PersonnelTemporaireHomme" id="PersonnelTemporaireHomme" placeholder="44"
                    v-model="step1.pers_temp_homm" :class="{ 'error-border': resultError['PersonnelTemporaireHomme'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="NbreEmploye">Nombre d'employés Guinéens <span class="text-danger">*</span></label>
                  <input type="text" name="NbreEmployeGuinne" id="NbreEmployeGuinne" placeholder="12"
                    v-model="step1.NbreEmployeGuinne" :class="{ 'error-border': resultError['NbreEmploye'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NbreActionnaireGuinneF" id="NbreActionnaireGuinneF" placeholder="11"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NbreActionnaireGuinneH" id="NbreActionnaireGuinneH" placeholder="55"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NbreActionnaireGuinne" id="NbreActionnaireGuinne" placeholder="33"
            ...
            <div class="row mb-3 mt-3 content-group">
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="PartChiffreAffaireExprtation">Part Chiffre d'Affaire d'Exportation
                  </label>
                  <input type="text" name="PartChiffreAffaireExprtation" id="PartChiffreAffaireExprtation"
                    placeholder="exemple" v-model="step1.part_chiffre_affaire_exprtation" :class="{
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="GroupeFililale" id="GroupeFililale" placeholder="exemple"
                    v-model="step1.grpe_fililale" :class="{ 'error-border': resultError['GroupeFililale'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre pays" v-model="step1.nationalite_groupe"
                    :options="sortedCountryOptions" v-slot="{ option }" search color="secondary" option-value-key="value"
                    option-label-key="label" option-input-value-key="value">
                    <div class="flex items-center" style="
                          padding-top: 0.5rem;
                          padding-bottom: 0.5rem;
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NumeroNif" id="NumeroNif" placeholder="1234567890L" v-model="step1.nbre_nif"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="date" name="DateGenerationNif" id="DateGenerationNif" placeholder=""
                    v-model="step1.DateGenerationNif" :class="{ 'error-border': resultError['DateGenerationNif'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx" @change="handleFileUploadNif"
                    name="FichierNif" id="FichierNif" placeholder=""
                    :class="{ 'error-border': resultError['FichierNif'] }" @input="resultError['FichierNif'] = false" />
                </div>
              </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NumeroRccm" id="NumeroRccm" placeholder="09R09999999" v-model="step1.nbre_rccm"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx" @change="handleFileUploadRccm"
                    name="FichierRccm" id="FichierRccm" placeholder=""
                    :class="{ 'error-border': resultError['FichierRccm'] }" @input="resultError['FichierRccm'] = false" />
                </div>
              </div>
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NumeroTva" id="NumeroTva" placeholder="exemple" v-model="step1.NumeroTva"
            ...
            <div class="row mb-3 mt-3 content-group">
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre Type Gestion" v-model="step1.CodeTypeGestion" color="secondary"
                    :options="TypesGestionsOptions" :class="{ 'error-border': resultError['CodeTypeGestion'] }"
                    @input="resultError['CodeTypeGestion'] = false" search />
                </div>
              </div>
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre  Type Contribuable" v-model="step1.CodeTypeContribuable"
                    color="secondary" :options="TypesContribuablesOptions"
                    :class="{ 'error-border': resultError['CodeTypeContribuable'] }"
                    @input="resultError['CodeTypeContribuable'] = false" search />
                </div>
              </div>
        ...
        <div class="form-container">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.mpmeBourse" color="secondary" :options="choix"
              ...
              <div class="col" v-if="step2.mpmeBourse === 'Oui'">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre  Bourse" v-model="step2.nomBourse" color="secondary"
                    :options="BourseOptions" :class="{ 'error-border': resultError['NomBourse'] }"
                    @input="resultError['NomBourse'] = false" search />
                </div>
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.receptionPrix" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['RecptionPrix'] }"
                    @input="resultError['RecptionPrix'] = false" search />
                </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col" v-if="step2.receptionPrix === 'Oui'">
                <div class="input-groupe">
                  ...
                  <input type="text" name="PrincipalPrix" id="PrincipalPrix" placeholder="exemple"
                    v-model="step2.principalPrix" :class="{ 'error-border': resultError['PrincipalPrix'] }"
              ...
              <div class="col" v-if="step2.receptionPrix === 'Oui'">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner une année" v-model="step2.anneePrixPrincipal" color="secondary"
                    :options="yearOptions" :class="{ 'error-border': resultError['AnneePrixPrincipal'] }"
                    @input="resultError['AnneePrixPrincipal'] = false" search />
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Monsieur ou Madame" v-model="step2.titreDirigeant" color="secondary"
                    :options="titre" :class="{ 'error-border': resultError['TitreDirigeant'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NomDirigeant" id="NomDirigeant" placeholder="Doe" v-model="step2.nomDirigeant"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="PrenomDirigeant" id="PrenomDirigeant" placeholder="John"
                    v-model="step2.prenomDirigeant" :class="{ 'error-border': resultError['PrenomDirigeant'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Masculin ou Feminin" v-model="step2.sexeDirigeant" color="secondary"
                    :options="sexes" :class="{ 'error-border': resultError['SexeDirigeant'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre pays" v-model="step2.paysDirigeant" :options="sortedCountryOptions"
                    v-slot="{ option }" search color="secondary" option-value-key="value" option-label-key="label"
                    option-input-value-key="value">
                    <div class="flex items-center" style="
                          padding-top: 0.5rem;
                          padding-bottom: 0.5rem;
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner une année" v-model="step2.anneeNaissanceDirigeant" color="secondary"
                    :options="yearOptions" :class="{ 'error-border': resultError['AnneeNaissanceDirigeant'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.dirigeantProprietaire" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['DirigeantProprietaire'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Monsieur ou Madamed" v-model="step2.titreProprietaire" color="secondary"
                    :options="titre" :class="{ 'error-border': resultError['TitreProprietaire'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NomProprietaire" id="NomProprietaire" placeholder="Doe"
                    v-model="step2.nomProprietaire" :class="{ 'error-border': resultError['NomProprietaire'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input type="text" name="PrenomProprietaire" id="PrenomProprietaire" placeholder="John"
                    v-model="step2.prenomProprietaire" :class="{ 'error-border': resultError['PrenomProprietaire'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Masculin ou Féminin" v-model="step2.sexeProprietaire" color="secondary"
                    :options="sexes" :class="{ 'error-border': resultError['SexeProprietaire'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner une année" v-model="step2.anneeNaissanceProprietaire" color="secondary"
                    :options="yearOptions" :class="{ 'error-border': resultError['AnneeNaissanceProprietaire'] }"
          ...
          <div class="content">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  <label for="AppartenanceReseauProfessionnel">Appartenance Reseau Professionnel
                    <span class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.appartenanceReseauProfessionnel"
                    color="secondary" :options="choix" :class="{
                        'error-border': resultError['AppartenanceReseauProfessionnel'],
                      }" @input="resultError['AppartenanceReseauProfessionnel'] = false" search />
                </div>
              ...
              <div class="col" v-if="step2.appartenanceReseauProfessionnel === 'Oui'">
                <div class="input-groupe">
                  ...
                  <input type="text" name="NomReseauProfessionnel" id="NomReseauProfessionnel" placeholder="exemple"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.financementFondPropre" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['FinancementFondPropre'] }"
                    @input="resultError['FinancementFondPropre'] = false" search />
                </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  <label for="FinancementCreditBancaire">Financement Credit Bancaire <span
                      class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.financementCreditBancaire" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['FinancementCreditBancaire'] }"
                    @input="resultError['FinancementCreditBancaire'] = false" search />
                </div>
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="FinancementPartenaireExterieurs">Financement Partenaire Exterieurs
                    <span class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.financementPartenaireExterieurs"
                    color="secondary" :options="choix" :class="{
                        'error-border': resultError['FinancementPartenaireExterieurs'],
                      }" @input="resultError['FinancementPartenaireExterieurs'] = false" search />
                </div>
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.financementAutre" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['FinancementAutre'] }"
                    @input="resultError['FinancementAutre'] = false" search />
                </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col" v-if="step2.financementAutre === 'Oui'">
                <div class="input-groupe">
                  ...
                  <input type="text" name="AutreFinancement" id="AutreFinancement" placeholder="exemple"
                    v-model="step2.autreFinancement" :class="{ 'error-border': resultError['AutreFinancement'] }"
            ...
            <div class="row mb-3 mt-3 content-group" v-if="step2.appartenanceReseauProfessionnel === 'Oui'">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazTextarea label="Entrez votre commentaire" v-model="step2.descriptionReseau" name="comment"
                    id="comment" color="secondary" :class="{ 'error-border': resultError['DescriptionReseau'] }"
          ...
          <div class="content">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  <label for="AchatMatierePremiere">Achat de Matières Premières Locales </label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.AchatMatierePremiere" color="secondary"
                    :options="chois" search :class="{ 'error-border': resultError['AchatMatierePremiere'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="Fournisseur">Fournisseurs locaux</label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.Fournisseur" color="secondary"
                    :options="chois" :class="{ 'error-border': resultError['Fournisseur'] }"
                    @input="resultError['Fournisseur'] = false" search />
                </div>
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="SousTraitence">Sous Traitence</label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.SousTraitence" color="secondary"
                    :options="chois" :class="{ 'error-border': resultError['SousTraitence'] }"
                    @input="resultError['SousTraitence'] = false" search />
                </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="PartMatierePremmiereAcheter">Part Matière Première Achetée
                  </label>
                  <input type="text" name="PartMatierePremmiereAcheter" id="PartMatierePremmiereAcheter" placeholder="123"
          ...
          <div class="content">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  <label for="ExistanceActionnaire">En activité <span class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step2.CodeZone" color="secondary" :options="choix"
                    :class="{ 'error-border': resultError['CodeZone'] }" @input="resultError['CodeZone'] = false"
                    search />
              ...
              <div class="col" v-if="step2.CodeZone === 'Non'">
                <div class="input-groupe">
                  <label for="DateFermetureMpme">Date de fermeture </label>
                  <input type="date" name="DateFermetureMpme" id="DateFermetureMpme" placeholder="01/01/1900"
                    v-model="step2.DateFermetureMpme" :class="{ 'error-border': resultError['DateFermetureMpme'] }"
                    @input="resultError['DateFermetureMpme'] = false" />
                  
                </div>
                <small v-if="v$.step2.DateFermetureMpme.$error">{{
                  v$.step2.DateFermetureMpme.$errors[0].$message
                  }}</small>
                <small v-if="resultError['DateFermetureMpme']">
                  {{ resultError["DateFermetureMpme"] }}
                </small>
              </div>
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazTextarea label="Entrez votre commentaire" v-model="step2.difficultesRencontrees" name="comment"
                    id="comment" color="secondary" :class="{ 'error-border': resultError['DifficultesRencontrees'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazTextarea label="Entrez votre commentaire" v-model="step2.suggestionsProposees" name="comment"
                    id="comment" color="secondary" :class="{ 'error-border': resultError['SuggestionsProposees'] }"
        ...
        <div class="form-container">
          ...
          <div class="content">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.existanceActionnaire" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['ExistanceActionnaire'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="ExistanceConseilAdministration">Existance Conseil Administration
                    <span class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.existanceConseilAdministration"
                    color="secondary" :options="choix" :class="{
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.existancePartenariat" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['ExistancePartenariat'] }"
                    @input="resultError['ExistancePartenariat'] = false" search />
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.partenariatTechnique" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['PartenariatTechnique'] }"
                    @input="resultError['PartenariatTechnique'] = false" search />
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.partenariatFinancier" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['PartenariatFinancier'] }"
                    @input="resultError['PartenariatFinancier'] = false" search />
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.partenariatCommercial" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['PartenariatCommercial'] }"
                    @input="resultError['PartenariatCommercial'] = false" search />
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.partenariatAutre" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['PartenariatAutre'] }"
                    @input="resultError['PartenariatAutre'] = false" search />
              ...
              <div class="col" v-if="step3.partenariatAutre === 'Oui'">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.autrePartenariat" type="text" name="FonctionRepondant" id="FonctionRepondant"
                    placeholder="exemple" :class="{ 'error-border': resultError['AutrePartenariat'] }"
                    @input="resultError['AutrePartenariat'] = false" search />
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.besoinPartenaire" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['BesoinPartenaire'] }"
                    @input="resultError['BesoinPartenaire'] = false" search />
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  <label for="BesoinPartenaireTechnique">Besoin Partenaire Technique<span
                      class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.besoinPartenaireTechnique" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['BesoinPartenaireTechnique'] }"
                    @input="resultError['BesoinPartenaireTechnique'] = false" search />
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="BesoinPartenaireFinancier">Besoin Partenaire Financier <span
                      class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.besoinPartenaireFinancier" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['BesoinPartenaireFinancier'] }"
                    @input="resultError['BesoinPartenaireFinancier'] = false" search />
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="BesoinPartenaireCommercial">Besoin Partenaire Commercial
                    <span class="text-danger">*</span></label>
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.besoinPartenaireCommercial" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['BesoinPartenaireCommercial'] }"
                    @input="resultError['BesoinPartenaireCommercial'] = false" search />
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.besoinPartenaireAutre" color="secondary"
                    :options="choix" :class="{ 'error-border': resultError['BesoinPartenaireAutre'] }"
                    @input="resultError['BesoinPartenaireAutre'] = false" search />
              ...
              <div class="col" v-if="step3.besoinPartenaireAutre === 'Oui'">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.autreBesoinPartenaire" type="text" name="FonctionRepondant" id="FonctionRepondant"
                    placeholder="exemple" :class="{ 'error-border': resultError['AutreBesoinPartenaire'] }"
                    @input="resultError['AutreBesoinPartenaire'] = false" search />
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.titreRepondant" color="secondary"
                    :options="titre" :class="{ 'error-border': resultError['TitreRepondant'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.nomRepondant" type="text" name="NomRepondant" id="NomRepondant" placeholder="Doe"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.fonctionRepondant" type="text" name="FonctionRepondant" id="FonctionRepondant"
                    placeholder="Chef de service" :class="{ 'error-border': resultError['FonctionRepondant'] }"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.adresseRepondant" type="text" name="AdresseRepondant" id="AdresseRepondant"
                    placeholder="12 conakry" :class="{ 'error-border': resultError['AdresseRepondant'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.villeRepondant" type="text" name="VilleRepondant" id="VilleRepondant"
                    placeholder="conakry" :class="{ 'error-border': resultError['VilleRepondant'] }"
              ...
              <div class="col">
                <div class="input-groupe">
                  <label for="TelephoneWhatsAppRepondant">Téléphone WhatsApp du Repondant
                    <span class="text-danger">*</span></label>
                  <MazPhoneNumberInput v-model="step3.telephoneWhatsAppRepondant" show-code-on-list color="secondary"
                    :ignored-countries="['AC']" @update="results = $event" :success="results?.isValid"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner Oui ou Non" v-model="step3.contacter" color="secondary" :options="choix"
          ...
          <div class="content">
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  <label for="TypeComptabilite">Type Comptabilite </label>
                  <MazSelect label="Sélectionner votre Type Comptabilite" v-model="step3.TypeComptabilite"
                    color="secondary" :options="Comptabilite" :class="{ 'error-border': resultError['TypeComptabilite'] }"
                    @input="resultError['TypeComptabilite'] = false" search />
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner votre carte" v-model="step3.TypeCarte" color="secondary"
                    :options="CarteTypeOptions" :class="{ 'error-border': resultError['TypeCarte'] }"
                    @input="resultError['TypeCarte'] = false" search />
              ...
              <div class="col" v-if="step3.TypeCarte !== null">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.NumeroCarte" type="text" name="NumeroCarte" id="NumeroCarte" placeholder="11AA11"
            ...
            <div class="row mb-3 mt-3 content-group">
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.lienGoogleMapMpme" type="text" name="LienGoogleMapMpme" id="LienGoogleMapMpme"
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <MazSelect label="Sélectionner un choix" v-model="step3.geolocalisation" color="secondary"
                    :options="choix" v-slot="{ option }" search>
                    <div class="flex items-center" style="
                          padding-top: 0.5rem;
                          padding-bottom: 0.5rem;
                          width: 100%;
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.latitudeMpme" type="text" name="LatitudeMpme" id="LatitudeMpme"
                    ...
                    @input="resultError['LatitudeMpme'] = false" :disabled="geolocalisationActive" />
              ...
              <div class="col">
                <div class="input-groupe">
                  ...
                  <input v-model="step3.longitudeMpme" type="text" name="LongitudeMpme" id="LongitudeMpme"
                    ...
                    @input="resultError['LongitudeMpme'] = false" :disabled="geolocalisationActive" />
      ...
      <MazDialog v-model="isOpen" noClose title="Modification de l'Entreprise">
        ...
        <template #footer>
          ...
          <div class="supp" @click="profil" style="background-color: var(--color-primary)">
            Oui
          </div>
        </template>
      </MazDialog>
      ...
      <MazDialog v-model="erreurmise" title="Erreur de mise à jour ">
        <p>Nous avons rencontré un problème lors de la tentative de mise à jour. Veuillez essayer à nouveau plus tard. Si
          le problème persiste, contactez notre support technique pour obtenir de l'aide.!!! </p>
        <template #footer="{ close }">
          <div class="supp" @click="close" style="background-color: blue">Ok</div>
        </template>
      </MazDialog>
      ...
      <MazDialog v-model="DemandeAide" noClose title="Demande d'aide">
        ...
        <template #footer="{ close }">
          ...
          <div class="supp" @click="HamdleAide" style="background-color: var(--color-primary)">
            Oui
          </div>
        </template>
      </MazDialog>
  ...
  methods: {
    createMpmeData() {
      return {
        ...
        NomBourse: this.step2.mpmeBourse !== 'Oui' ? "" : this.step2.nomBourse,
        RecptionPrix: this.step2.receptionPrix,
        PrincipalPrix: this.step2.receptionPrix !== "Oui" ? "" : this.step2.principalPrix,
        AnneePrixPrincipal: this.step2.receptionPrix !== "Oui" ? null : parseInt(this.step2.anneePrixPrincipal),
        ...
        NomReseauProfessionnel:this.step2.appartenanceReseauProfessionnel !== "Oui" ? "" : this.step2.nomReseauProfessionnel,
        ...
        DescriptionReseau: this.step2.appartenanceReseauProfessionnel !== "Oui" ? "" : this.step2.descriptionReseau,
        ...
        DateFermetureMpme: this.step2.CodeZone === 'Oui' ? null  : this.step2.DateFermetureMpme ,
    ...
    createMpmeFormData() {
      ...
      formData.append('DateFermetureMpme', this.step2.DateFermetureMpme);
    ...
    async fetchgetOneMpme() {
      try {
        ...
        if (response.data.data === undefined) {
          ...
          if ((CodeIdentifiant === this.loggedInUser.id) && localStorageUserData) {
    ...
    storeUserData(userData) {
      ...
      this.step2.DateFermetureMpme = userData.DateFermetureMpme;
    ...
    calculerNombreAnnees() {
      ...
      if (this.step2.CodeZone === 'Non') {
        // Assurez-vous que step2.DateFermetureMpme est une chaîne au format YYYY-MM-DD
        const DateFermetureMpme = new Date(this.step2.DateFermetureMpme);

        // Vérifiez si la date est valide
        if (!isNaN(DateFermetureMpme.getTime())) {
          const dateActuelle = new Date();
          const differenceAnnees = dateActuelle.getFullYear() - DateFermetureMpme.getFullYear();
